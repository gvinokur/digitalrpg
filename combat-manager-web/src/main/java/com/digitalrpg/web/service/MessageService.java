...
public class MessageService {
    ...
    public static Function<Message, MessageVO> messageToVOFunction = new Function<Message, MessageVO>() {
        ...
        private MessageVO translateInviteToClaimCharacterMessage(InviteToClaimCharacterMessage message) {
        ...
        private MessageVO translateAcceptRequestJoinMessage(AcceptRequestMessage message) {
        ...
        private void setBaseProperties(MessageVO out, Message in) {
            out.setFrom(UserService.userToVOFuction.apply(in.getFrom()));
            out.setTo(UserService.userToVOFuction.apply(in.getTo()));
     ...
     * @return
     */
    public MessageVO invite(User from, String emailTo, User userTo, Campaign campaign) {
     ...
     * @return
     */
    public MessageVO invite(Long id, User from, String emailTo, User userTo, SystemCharacter character) {
